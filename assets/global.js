...
class CustomCarousel extends HTMLElement {
    ...
    if (breakpoints) {
      ...
      this.breakpoints.forEach((breakpoint, index) => {
        if (this.currentWidth >= breakpoint) {
          ...
          return _objectSpread(_objectSpread({}, this.breakpointSettings), otherSettings);
        }
      });
    }
  ...
  getNavigationandPagination(breakpointSettings) {
    var {
        pagination = this.getCarouselSettingsl.pagination,
        navigation = this.getCarouselSettingsl.pagination
      } = breakpointSettings,
      ...
      on: {
        beforeInit: () => {
          var {
            navigation,
            pagination
          } = this.getNavigationandPagination(currentBreakPointSettings) || {};
          if (!navigation) {
