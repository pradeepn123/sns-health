<script>
  ...
  let ref;
  $:expiryDateData = {};
  $:({isFinalSale, expiryDate} = expiryDateData)
  ...
  const getExpiryData = async(handle) => {
    ...
    expiryDateData.isFinalSale = isFinalSaleFromJson;
    expiryDateData.expiryDate = expiryDateFromJson;
    expiryDateData = expiryDateData; //reassigning value
  } 
